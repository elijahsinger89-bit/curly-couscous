...
| S-18 | WATER: chiller loop, commanded by MAIN-PANEL's contactor | CONTROL-SOFTWARE: verification windows | DECIDED 2026-08-30 by D-023, provisional on WATER. The chiller is HELD OFF across settle windows. Read cleanliness beats a small temperature excursion on a 40 gal tank over a window measured in minutes. Chiller cycling moves tank temperature, and temperature moves both the pH and the compensated EC readings | WATER to confirm that nothing about the chiller's duty cycle, its own compressor protection or its minimum off time makes holding it off unsafe. Until WATER answers, provisional |
