...
| S-03 | MAIN-PANEL: a 55.34 contact wetted at 24 V, single series branch through an optocoupler LED, burden in the MAIN PANEL | DISPLAY-BOX: isolated Pi input, sense INVERTED | **TOPOLOGY CLOSED 2026-08-30 by D-035. Same shape as S-08, DIFFERENT NUMBERS, and not a copy.** The 55.34's minimum is 300 mW at 5 V and 5 mA, about 12.5 mA at 24 V, against the 22.32's about 41.7 mA. At 12.5 mA a single series branch carries the whole loop and the LED sits in its normal band, so S-03 does NOT get S-08's two-branch arrangement: that would add a part for nothing. **G-23: a minimum switching load belongs to a contact and no figure is carried from the other.** **G-22: a severed cable reads as contact open, which is the safe state, and that is a chosen property** | MAIN-PANEL sizes it independently. DISPLAY-BOX's input side still open |
